...
import { openInviteUser } from '@lib/matrix/action/navigation';
	...
	return (
		<>
			...
			<div className="room-settings__card">
				...
				<MenuItem
					variant="danger"
					onClick={() => roomActions.leave(roomId)}
		...
		<div className="room-settings">
			<ScrollView autoHide>
				<div className="room-settings__content">
					...
					<Tabs
						items={tabItems}
						defaultSelected={tabItems.findIndex(
							(tab) => tab.text === selectedTab.text
						)}
